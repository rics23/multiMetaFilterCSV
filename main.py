...
print("    multiMetaFilterCSV  Copyright (C) 2024  Ricardo Lopes  rics.23@gmail.com")
print("    This program comes with ABSOLUTELY NO WARRANTY; for details read licensing file.")
